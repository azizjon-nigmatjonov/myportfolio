...
export default function ProjectHeader() {
    return <div className="container">
        <div className="border-t border-gray-600 py-5 flex sm:space-x-10 lg:space-x-0 lg:grid lg:grid-cols-2">
        ...
        <div className="flex justify-end"><span className="text-gray-400 text-[12px] sm:text-base">React.js</span></div>
    </div>
    </div>
}